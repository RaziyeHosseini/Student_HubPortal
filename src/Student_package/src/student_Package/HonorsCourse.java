...
public class HonorsCourse extends Courses {
	 ...
	 * <p>
	 * HonorsCourse is a specialized {@link Courses} instance where the honors flag
	 * is always true. Credit hours are provided at construction time and used later
	 * by {@link GPACalculator} when computing weighted GPA.
	 *
	 * @param courseName  the display name of the course (without honors or credit
	 *                    markers)
	...
	/**
	 * Calculate grade points for the given letter grade in this honors course.
	 * Honors courses add one bonus point to non-failing grades.
	 *
	 * This method is called by {@link GPACalculator#calculateGPA} for each course
	 * when computing the weighted GPA.
	 *
